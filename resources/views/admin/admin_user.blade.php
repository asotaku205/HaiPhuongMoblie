                ...
                <form action="{{ route('admin.user.search') }}" method="GET" class="flex items-center w-full md:w-auto">
                    <div class="relative flex-grow md:w-80">
                        ...
                        <div class="absolute inset-y-0 right-0 flex items-center">
                            ...
                            <!-- @if(request('search'))
                            <a href="{{ route('admin_user') }}" class="p-1 focus:outline-none focus:shadow-outline hover:text-red-500 mr-3">
                                <span class="sr-only">Xóa tìm kiếm</span>
                                <svg class="h-5 w-5 text-gray-500 hover:text-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
