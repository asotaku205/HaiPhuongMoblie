...
<div class="bg-white rounded-lg shadow overflow-hidden">
    ...
    <div class="p-6 border-b border-gray-200">
        <div class="flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0">
            ...
            <form action="{{ route('product.search') }}" method="GET" class="flex items-center w-full md:w-auto">
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                    <p class="text-sm text-gray-700">
                        Hiển thị <span class="font-medium">{{ $all_product->firstItem() }}</span> đến <span class="font-medium">{{ $all_product->lastItem() }}</span> của <span
